...
const Events = () => {
  return (
    <div className="bg-black w-full h-full flex flex-col md:flex md:flex-row">
      <div className="md:w-1/2 bg-black px-2 lg:px-10 py-20 flex flex-col gap-5">
      ...
      <div className="flex-1 bg-black px-10 py-20">
        <div className="image_div w-full  md:w-[300px] md:h-[400px] lg:w-[500px]">
