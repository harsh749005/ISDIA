...
const AboutAaquarians = () => {
  return (
    <div className="bg-black w-full h-max flex flex-col xl:flex xl:flex-row">
      <div className="w-full xl:w-1/2 bg-black px-2 md:px-5  lg:px-10 md:py-10 lg:py-20 flex flex-col gap-5 ">
        ...
        <p className="text-gray-400  md:font-medium text-sm font-poppins">
          Aaquarians.ai is a group of professionals comprising Ph.Ds &
          Postgraduates in AI Technologies and Data Sciences having played
          multiple roles in the areas of Software Product Development in the
          industry with world Top Tier1 Global Multi-National companies &
          Applied Research in well-known Universities. Having worked in both AI
          Technologies & in Governance, Risk & Compliance domains, the team has
          the unique advantage of being at the intersection of both AI & at
          Governance domains.
          <br className="md:hidden" />{" "}
          <span className="text-white w-max px-2 bg-[#9d66ff] font-medium italic ">
            3, 500 students representing 108 nationalities.
          </span>
        </p>
      </div>
